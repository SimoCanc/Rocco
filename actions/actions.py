...
#TODO: mettere alternativa ELSE in caso di nessun match nell IF
...
class ActionCallPlumber(Action):
  ...
  def run(self, 
      ...
      #TODO: Provare a mettere la variabile selected_intent come globale
      selected_intent = Tracker.get_intent_of_latest_message()[-3:]
